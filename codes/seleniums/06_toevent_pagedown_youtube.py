...
time.sleep(1)
# browser.implicitly_wait(10) 명확하게 알 수 없으면 하면 안댄다, 그러면 이거는 왜 쓰나? 확인용~ 잘 동작하는거 보이면 time.sleep으로 하자
...
while True:
    # ActionChains(browser).key_down(Keys.PAGE_DOWN).perform() (1)클래스.펑션.(2)펑션 > 1클래스.2펑션 
